  ...
  return (
    <section className="flex justify-center">
      ...
      >
        ...
        <div className="relative flex flex-col items-center gap-[50px]">
          <div className="flex flex-col items-center gap-5 text-center text-neutral-800">
            <h2 className="text-[40px] font-bold leading-[1.4] tracking-[-1px]">
              {title}
            </h2>
            <p className="text-xl font-medium leading-[1.4] tracking-[-0.5px]">
              {subtitle}
            </p>
          </div>
